...
\capbtabbox{%
      ...
      \caption{Baic chess notations}
      \label{tab:bsic_chess_notations}
}
\ffigbox{%
	  \includegraphics[scale=0.5]{images/algebraic_notation.png}
}{%
	  \caption{Suare names in algebraic notation}
	  % https://en.wikipedia.org/wiki/Algebraic_notation_(chess)#/media/File:SCD_algebraic_notation.svg (18.03.2019, 20:56)
      \label{fig:suare_names}
}
\end{floatrow}
\end{figure}
